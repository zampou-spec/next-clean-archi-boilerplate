  ...
  <Box className={styles.homeAbout}>
    <Box className={styles.textContainer}>
      <Typography component="p" variant="body1" className={styles.text}>
        ...
        pellentesque. Mi enim mattis sit varius adipiscing tristique aliquam. Ac turpis ultricies varius velit pellentesque. Lorem
        ipsum dolor sit amet consectetur. Tempor volutpat purus nibh id. Mauris justo quisque neque tempus sed vitae pellentesque.
        Mi enim mattis sit varius adipiscing tristique aliquam. Ac turpis ultricies varius velit pellentesque.
      </Typography>
      <Typography component="p" variant="body1" className={styles.text}>
