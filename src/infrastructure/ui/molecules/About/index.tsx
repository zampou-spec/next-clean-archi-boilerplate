  ...
  <Grid container alignItems="center" justifyContent="center" spacing={2} className={styles.about}>
    ...
    <Grid xs={12} sm={6} md={6}>
      <Typography variant="body1" className={styles.text}>
        ...
        dolor sit amet consectetur adipisicing elit. Saepe quos amet eius ea sed voluptatem. Rem quaerat consequatur officia sunt
        quibusdam suscipit dolorum. Odit magni temporibus similique perspiciatis impedit accusantium.
      </Typography>
    </Grid>
  </Grid>
);
